# CI/CD Project Using Terraform, Jenkins, SonarQube, Trivy, JFrog Artifactory, and Amazon EKS

## Deploying Web Application

### Repository
[Bitbucket Repository](https://bitbucket.org/myrepositoryproject/registration-app/src/main/)

### Prerequisites
- [AWS CLI Download](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
- [VS Code Download](https://code.visualstudio.com/download)

## A. Terraform Setup for EC2 Instance
